...
class vistaReporteFactura:
    ...
    # Encabezados de las columnas
        ...
        self.tabla.column("id_factura",width= 80, anchor="w")
        self.tabla.column("subtotal",width= 80, anchor="w")
        self.tabla.column("impuesto",width= 80, anchor="w")
        self.tabla.column("descuento",width= 80, anchor="w")
        self.tabla.column("total",width= 80, anchor="w")
        self.tabla.column("id_cita",width= 80, anchor="w")
        self.tabla.column("nombre_cliente",width= 100, anchor="w")
