...
class vistaInventario:
    def administrarInventario(self,base, callback=None):
        ...
        tabla= ttk.Treeview(groupBox,columns=("id_producto","nombre_producto","descripcion", "precio_unitario", "stock", "id_marca", "id_categoria"), show="headings", height=5,)
        tabla.heading("id_producto", text="Identificacion")
        tabla.column("id_producto",width=100, anchor="w")
